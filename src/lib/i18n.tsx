...
const translations = {
  es: {
    ...
    whyUs: {
      ...
      pillars: [
        { icon: "Zap", title: "Respuesta en 15 minutos", desc: "Tu cotización lista en menos tiempo del que tarda un café." },
        { icon: "UserCheck", title: "Asesor personal dedicado", desc: "Un experto que te conoce, conoce tu vida y tus riesgos." },
        { icon: "Star", title: "Atención VIP siempre", desc: "WhatsApp prioritario, sin filas, sin bots, sin esperas." },
        { icon: "RefreshCw", title: "Revisión anual incluida", desc: "Ajustamos tu cobertura cada año sin que tengas que pedir." },
        { icon: "Users", title: "Red de aliados premium", desc: "Acceso a clínicas, talleres y servicios de primer nivel." },
        { icon: "TrendingUp", title: "Tecnología inteligente", desc: "Portal digital para ver tus pólizas, pagos y reclamos." },
      ],
    },
    howItWorks: {
  ...
  en: {
    ...
    whyUs: {
      ...
      pillars: [
        { icon: "Zap", title: "Quote in 15 minutes", desc: "Your quote ready faster than it takes to finish a coffee." },
        { icon: "UserCheck", title: "Dedicated personal advisor", desc: "An expert who knows you, your life and your risks." },
        { icon: "Star", title: "VIP service always", desc: "Priority WhatsApp, no queues, no bots, no waiting." },
        { icon: "RefreshCw", title: "Annual review included", desc: "We adjust your coverage every year without you having to ask." },
        { icon: "Users", title: "Premium partner network", desc: "Access to top-tier clinics, workshops and services." },
        { icon: "TrendingUp", title: "Smart technology", desc: "Digital portal to view your policies, payments and claims." },
      ],
    },
    howItWorks: {
      eyebrow: "That simple",
